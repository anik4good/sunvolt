...
const SERIES: Row[] = [
  {
    ...
    features: [
      ...
      "System Voltage: 12V DC (Single Battery)",
      "Solar Tech: PWM Charge Controller",
      "Max Solar Panel: 400–500W",
      "Display: Digital LCD",
      "Design: Vertical Wall-Mount",
  ...
  },
  {
    ...
    features: [
      ...
      "System Voltage: 12V DC (Single Battery)",
      "Solar Tech: PWM Charge Controller",
      "Max Solar Panel: up to 600W",
      "Display: Digital LCD Status",
      "Charging: 5-Stage + ATM Trickle Mode",
      "Surge Handling: Desktop PC Ready",
    ],
    highlights: [
      "Vertical Wall-Mount Design",
  ...
  },
  {
    ...
    features: [
      ...
      "Pure Sine Wave Output",
      "System Voltage: 12V DC (Single Battery)",
      "Solar Tech: MPPT / High-Efficiency PWM",
      "Max Solar Panel: 800–1000W",
      "Display: Multi-Color LCD",
      "Design: Vertical Wall-Mount",
      "MPPT Boost: up to 30% More Power",
    ],
    highlights: [
  ...
  },
  {
    ...
    features: [
      "Capacity: 1250–1450VA (~1000–1100W)",
      "Pure Sine Wave Output",
      "System Voltage: 12V DC (Single Battery)",
      "Solar Tech: Smart MPPT/PWM Management",
      "Max Solar Panel: 1000–1200W",
      "Display: Advanced Digital LCD",
      "Design: Heavy-Duty Wall-Mount Chassis",
      "Protection: SC, Deep-Discharge, Overload, Reverse",
    ],
    highlights: [
