...
const SERIES: Row[] = [
  {
    ...
    features: [
      "Vertical wall-mount design saves floor space",
      "Smart solar selection prioritizes solar power to cut bills",
      "Runs 2–3 ceiling fans, 4–5 LED lights, router & mobile charging",
  ...
  },
  {
    ...
    features: [
      "High surge handling — runs a desktop PC with standard home loads",
      "Intelligent grid/solar priority switching maximizes battery life",
      "Runs desktop PC, 3–4 fans, 5–7 LED lights, 32\"–43\" LED TV & router",
      "Compatible with tubular, flat plate & SMF batteries",
      "Digital LCD display with full status indications",
    ],
    highlights: [
      "Vertical Wall-Mount Design",
  ...
  },
  {
    ...
    features: [
      "MPPT extracts up to 30% more solar power than standard PWM",
      "Heavy-load support designed for extended backup",
      "Runs multiple laptops, 4–5 fans, 8–10 lights, 55\"+ TV & CCTV",
  ...
  },
  {
    ...
    features: [
      "Highest capacity on a 12V single-battery system — no costly 24V setup",
      "Advanced protection: short-circuit, deep discharge, overload & reverse polarity",
      "Runs energy-efficient fridge, mixer grinder (short duration), full home lighting, multiple fans & TVs",
      "Advanced digital LCD display",
      "Pure sine wave output safe for sensitive electronics",
    ],
    highlights: [
