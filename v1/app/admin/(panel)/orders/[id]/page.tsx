  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <span className="rounded-full bg-secondary px-3 py-1 text-sm font-semibold capitalize text-foreground">
          {order.status}
        </span>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card>
          <CardContent className="p-5">
            ...
            {info(
              "Phone",
              <a href={`tel:${order.phone}`} className="text-foreground hover:underline">
                {order.phone}
              </a>,
            )}
      ...
      {appliances.length > 0 ? (
        <Card>
          <CardContent className="p-5">
            <h2 className="mb-2 font-bold text-foreground">Customer&rsquo;s Calculation</h2>
            ...
            <div className="mt-3 flex flex-wrap gap-x-6 gap-y-1 text-sm font-semibold text-foreground">
