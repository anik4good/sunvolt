...
/** Standard WhatsApp-styled anchor used across the site. */
export function WhatsAppButton({
  ...
  return (
    <a
      ...
      className={cn(
        "inline-flex h-12 items-center justify-center gap-2 rounded-xl bg-whatsapp px-6 text-sm font-bold text-white shadow-sm transition-opacity hover:opacity-90",
        className,
      )}
    >
