...
export function ProductForm({
  ...
  return (
    <form action={formAction} className="mt-6 space-y-6">
      ...
      {isPanel ? (
        <div className="grid gap-4 rounded-xl border border-solar/40 bg-solar-light/30 dark:bg-solar/10 p-4 sm:grid-cols-3">
          <Field
          ...
          <Field label="Calculated price" hint="Rate × watts — fills Price below">
            <div className="flex h-9 items-center rounded-md border bg-card px-3 text-sm font-semibold text-foreground">
              {computedPrice != null
