  ...
  return (
    <div className="space-y-6">
      <div className="rounded-xl border bg-card p-5">
        ...
        {newKey ? (
          <div className="mt-4 rounded-xl border border-solar/50 bg-solar-light/50 dark:bg-solar/10 p-4">
            <p className="text-sm font-bold text-solar-dark dark:text-solar">
              Copy this key now — it will never be shown again:
            </p>
            <div className="mt-2 flex flex-col gap-2 sm:flex-row sm:items-center">
              <code className="flex-1 overflow-x-auto rounded-lg bg-background px-3 py-2 font-mono text-sm text-foreground">
                {newKey}
              </code>
