    ...
    <form action={formAction} className="space-y-6">
          ...
          <div className="space-y-3">
            {rows.map((row, index) => (
              <div key={index} className="flex flex-wrap items-end gap-2">
                ...
                <div className="w-24 pb-2 text-right text-sm font-semibold text-foreground">
      ...
      <div className="flex items-center justify-between gap-4 rounded-xl border bg-card p-5">
        <div>
          ...
          <p className="text-2xl font-extrabold text-foreground">{formatPrice(total, currency)}</p>
        </div>
