...
export function SettingsForm({ settings }: { settings: Settings }) {
  ...
  return (
    <form action={formAction} className="mt-6 space-y-6">
        ...
        {tabs.map(([key, label]) => (
          <button
            ...
            className={`rounded-t-lg border-b-2 px-4 py-2 text-sm font-medium transition-colors ${
              tab === key
                ? "border-solar font-semibold text-foreground"
      ...
      <div>
        <h2 className="text-sm font-bold text-foreground">Calculation parameters</h2>
        <p className="mt-1 text-xs text-muted-foreground">
      ...
      <div>
        <h2 className="text-sm font-bold text-foreground">Custom system sizing</h2>
        <p className="mt-1 text-xs text-muted-foreground">
      ...
      <div>
        <h2 className="text-sm font-bold text-foreground">Solar panel pricing</h2>
        <p className="mt-1 text-xs text-muted-foreground">
