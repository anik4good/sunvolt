            ...
            >
              ...
              {index === 0 ? (
                ...
                <button
                  ...
                  className="absolute left-1.5 top-1.5 rounded-full bg-background/90 p-1.5 text-navy/70 opacity-0 transition-opacity hover:text-solar-dark focus-visible:opacity-100 group-hover:opacity-100"
